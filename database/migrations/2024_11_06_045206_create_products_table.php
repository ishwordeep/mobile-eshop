...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        //     $table->timestamps();
        // });
        // Schema::create('product_specifications_subheader', function (Blueprint $table) {
        //     $table->id();
        //     $table->foreignId('header_id')->constrained('product_specifications_header')->onDelete('cascade');
        ...
        //     $table->id();
        //     $table->foreignId('header_id')->constrained('product_specifications_header')->onDelete('cascade');
        //     $table->foreignId('subheader_id')->constrained('product_specifications_subheader')->onDelete('cascade');
